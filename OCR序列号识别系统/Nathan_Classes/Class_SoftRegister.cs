...
class Class_SoftRegister
    {
        public static int InitRegedit()
        {
            ...
            Debug.WriteLine("SericalNumber:" + SericalNumber);
        ...
        public static string ReadSetting(string Section, string Key, string Default)
        {
            ...
            Microsoft.Win32.RegistryKey key1 = Microsoft.Win32.Registry.CurrentUser.OpenSubKey("Software\\Ocr_AutoSystem\\key1");
        if (key1 != null)
        {
            ...
            if (obj1 != null)
            {
                ...
                obj2 = Encrypt.Class_DES.DesDecrypt(obj2);
                return obj2;
            }
            return "-1";
        }
        ...
        {
            Microsoft.Win32.Registry.CurrentUser.CreateSubKey("Software\\Ocr_AutoSystem\\key1");
            WriteSetting("", "SerialNumber", Encrypt.Class_DES.DesEncrypt(CreatSerialNumber()));
        }
            return Default;
        }
    }
